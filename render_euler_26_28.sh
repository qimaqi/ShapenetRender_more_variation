...
python3 render_batch.py --filelist_dir=filelists_026_028  # --debug=True
# sbatch --output=sbatch_log/26_30.out  --ntasks=16 --mem-per-cpu=4g --time=4-0 --gpus=rtx_4090:1 render_euler_26_28.sh
# 801121
